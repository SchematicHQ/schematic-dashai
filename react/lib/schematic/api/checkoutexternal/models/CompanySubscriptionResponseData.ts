 ...
 */
export function instanceOfCompanySubscriptionResponseData(value: object): value is CompanySubscriptionResponseData {
...
export function CompanySubscriptionResponseDataToJSON(json: any): CompanySubscriptionResponseData {
    return CompanySubscriptionResponseDataToJSONTyped(json, false);
}

export function CompanySubscriptionResponseDataToJSONTyped(value?: CompanySubscriptionResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'cancel_at': value['cancelAt'] == null ? undefined : ((value['cancelAt'] as any).toISOString()),
