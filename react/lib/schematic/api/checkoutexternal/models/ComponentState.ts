...
export function ComponentStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): ComponentState {
...
export function ComponentStateToJSONTyped(value: any, ignoreDiscriminator: boolean): ComponentState {
