 ...
 */
export function instanceOfEntityTraitDetailResponseData(value: object): value is EntityTraitDetailResponseData {
...
export function EntityTraitDetailResponseDataFromJSON(json: any): EntityTraitDetailResponseData {
    return EntityTraitDetailResponseDataFromJSONTyped(json, false);
}

export function EntityTraitDetailResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityTraitDetailResponseData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'definition': json['definition'] == null ? undefined : EntityTraitDefinitionResponseDataFromJSON(json['definition']),
...
export function EntityTraitDetailResponseDataToJSON(json: any): EntityTraitDetailResponseData {
    return EntityTraitDetailResponseDataToJSONTyped(json, false);
}

export function EntityTraitDetailResponseDataToJSONTyped(value?: EntityTraitDetailResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
