 ...
 */
export function instanceOfFeatureInPlanResponseData(value: object): value is FeatureInPlanResponseData {
...
export function FeatureInPlanResponseDataFromJSON(json: any): FeatureInPlanResponseData {
    return FeatureInPlanResponseDataFromJSONTyped(json, false);
}

export function FeatureInPlanResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): FeatureInPlanResponseData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'lifecyclePhase': json['lifecycle_phase'] == null ? undefined : FeatureLifecyclePhaseFromJSON(json['lifecycle_phase']),
        'maintainerAccountMemberId': json['maintainer_account_member_id'] == null ? undefined : json['maintainer_account_member_id'],
        'name': json['name'],
        ...
        'usageLimitTraitId': json['usage_limit_trait_id'] == null ? undefined : json['usage_limit_trait_id'],
    };
}

export function FeatureInPlanResponseDataToJSON(json: any): FeatureInPlanResponseData {
    return FeatureInPlanResponseDataToJSONTyped(json, false);
}

export function FeatureInPlanResponseDataToJSONTyped(value?: FeatureInPlanResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
