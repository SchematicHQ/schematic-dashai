 ...
 */
export function instanceOfUsageBasedEntitlementResponseData(value: object): value is UsageBasedEntitlementResponseData {
    if (!('featureId' in value) || value['featureId'] === undefined) return false;
    if (!('valueType' in value) || value['valueType'] === undefined) return false;
    return true;
}

export function UsageBasedEntitlementResponseDataFromJSON(json: any): UsageBasedEntitlementResponseData {
    return UsageBasedEntitlementResponseDataFromJSONTyped(json, false);
}

export function UsageBasedEntitlementResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UsageBasedEntitlementResponseData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'meteredPrice': json['metered_price'] == null ? undefined : BillingPriceViewFromJSON(json['metered_price']),
...
export function UsageBasedEntitlementResponseDataToJSON(json: any): UsageBasedEntitlementResponseData {
    return UsageBasedEntitlementResponseDataToJSONTyped(json, false);
}

export function UsageBasedEntitlementResponseDataToJSONTyped(value?: UsageBasedEntitlementResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
