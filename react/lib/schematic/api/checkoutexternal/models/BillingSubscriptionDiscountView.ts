 ...
 */
export function instanceOfBillingSubscriptionDiscountView(value: object): value is BillingSubscriptionDiscountView {
    if (!('couponId' in value) || value['couponId'] === undefined) return false;
    if (!('couponName' in value) || value['couponName'] === undefined) return false;
    if (!('discountExternalId' in value) || value['discountExternalId'] === undefined) return false;
...
export function BillingSubscriptionDiscountViewFromJSON(json: any): BillingSubscriptionDiscountView {
    return BillingSubscriptionDiscountViewFromJSONTyped(json, false);
}

export function BillingSubscriptionDiscountViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): BillingSubscriptionDiscountView {
    if (json == null) {
        return json;
    }
    return {
        ...
        'customerFacingCode': json['customer_facing_code'] == null ? undefined : json['customer_facing_code'],
        ...
        'promoCodeExternalId': json['promo_code_external_id'] == null ? undefined : json['promo_code_external_id'],
        'startedAt': (new Date(json['started_at'])),
        'subscriptionExternalId': json['subscription_external_id'],
    };
}

export function BillingSubscriptionDiscountViewToJSON(json: any): BillingSubscriptionDiscountView {
    return BillingSubscriptionDiscountViewToJSONTyped(json, false);
}

export function BillingSubscriptionDiscountViewToJSONTyped(value?: BillingSubscriptionDiscountView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
