...
export function RuleFromJSONTyped(json: any, ignoreDiscriminator: boolean): Rule {
    ...
    return {
        ...
        'conditionGroups': ((json['condition_groups'] as Array<any>).map(ConditionGroupFromJSON)),
...
export function RuleToJSONTyped(value?: Rule | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'condition_groups': ((value['conditionGroups'] as Array<any>).map(ConditionGroupToJSON)),
