 ...
 */
export function instanceOfFeatureResponseData(value: object): value is FeatureResponseData {
...
export function FeatureResponseDataToJSONTyped(value?: FeatureResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
