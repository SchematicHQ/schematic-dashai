 ...
 */
export function instanceOfCompanyEventPeriodMetricsResponseData(value: object): value is CompanyEventPeriodMetricsResponseData {
    if (!('accountId' in value) || value['accountId'] === undefined) return false;
    if (!('capturedAtMax' in value) || value['capturedAtMax'] === undefined) return false;
    if (!('capturedAtMin' in value) || value['capturedAtMin'] === undefined) return false;
    ...
    if (!('monthReset' in value) || value['monthReset'] === undefined) return false;
    if (!('period' in value) || value['period'] === undefined) return false;
    if (!('value' in value) || value['value'] === undefined) return false;
    return true;
}

export function CompanyEventPeriodMetricsResponseDataFromJSON(json: any): CompanyEventPeriodMetricsResponseData {
    return CompanyEventPeriodMetricsResponseDataFromJSONTyped(json, false);
}

export function CompanyEventPeriodMetricsResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompanyEventPeriodMetricsResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function CompanyEventPeriodMetricsResponseDataToJSON(json: any): CompanyEventPeriodMetricsResponseData {
    return CompanyEventPeriodMetricsResponseDataToJSONTyped(json, false);
}

export function CompanyEventPeriodMetricsResponseDataToJSONTyped(value?: CompanyEventPeriodMetricsResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
