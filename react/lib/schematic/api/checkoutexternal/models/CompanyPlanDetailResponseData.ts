 ...
 */
export function instanceOfCompanyPlanDetailResponseData(value: object): value is CompanyPlanDetailResponseData {
    if (!('availablePeriods' in value) || value['availablePeriods'] === undefined) return false;
    if (!('billingStrategy' in value) || value['billingStrategy'] === undefined) return false;
    if (!('chargeType' in value) || value['chargeType'] === undefined) return false;
    if (!('companyCanTrial' in value) || value['companyCanTrial'] === undefined) return false;
    if (!('companyCount' in value) || value['companyCount'] === undefined) return false;
    if (!('compatiblePlanIds' in value) || value['compatiblePlanIds'] === undefined) return false;
    ...
    if (!('currencyPrices' in value) || value['currencyPrices'] === undefined) return false;
    ...
    if (!('includedCreditGrants' in value) || value['includedCreditGrants'] === undefined) return false;
    if (!('isCustom' in value) || value['isCustom'] === undefined) return false;
    if (!('isDefault' in value) || value['isDefault'] === undefined) return false;
    if (!('isTrialable' in value) || value['isTrialable'] === undefined) return false;
    if (!('name' in value) || value['name'] === undefined) return false;
    if (!('planType' in value) || value['planType'] === undefined) return false;
    if (!('updatedAt' in value) || value['updatedAt'] === undefined) return false;
    if (!('usageViolations' in value) || value['usageViolations'] === undefined) return false;
    if (!('valid' in value) || value['valid'] === undefined) return false;
    if (!('versions' in value) || value['versions'] === undefined) return false;
    return true;
}

export function CompanyPlanDetailResponseDataFromJSON(json: any): CompanyPlanDetailResponseData {
    return CompanyPlanDetailResponseDataFromJSONTyped(json, false);
}

export function CompanyPlanDetailResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompanyPlanDetailResponseData {
    if (json == null) {
        return json;
    }
    return {
        
        'activeVersion': json['active_version'] == null ? undefined : PlanVersionResponseDataFromJSON(json['active_version']),
        'audienceType': json['audience_type'] == null ? undefined : json['audience_type'],
        'availablePeriods': ((json['available_periods'] as Array<any>).map(PlanPriceCadenceFromJSON)),
        'billingLinkedResource': json['billing_linked_resource'] == null ? undefined : BillingLinkedResourceResponseDataFromJSON(json['billing_linked_resource']),
        'billingProduct': json['billing_product'] == null ? undefined : BillingProductDetailResponseDataFromJSON(json['billing_product']),
        'billingStrategy': BillingStrategyFromJSON(json['billing_strategy']),
        'catalogs': json['catalogs'] == null ? undefined : ((json['catalogs'] as Array<any>).map(PlanCatalogMembershipResponseDataFromJSON)),
        'chargeType': ChargeTypeFromJSON(json['charge_type']),
        'companyCanTrial': json['company_can_trial'],
        'companyCount': json['company_count'],
        'companyId': json['company_id'] == null ? undefined : json['company_id'],
        'companyLogoUrl': json['company_logo_url'] == null ? undefined : json['company_logo_url'],
        ...
        'copiedFromPlanId': json['copied_from_plan_id'] == null ? undefined : json['copied_from_plan_id'],
        'createdAt': (new Date(json['created_at'])),
        'credits': ((json['credits'] as Array<any>).map(BillingCreditResponseDataFromJSON)),
        'currencyPrices': ((json['currency_prices'] as Array<any>).map(PlanCurrencyPricesResponseDataFromJSON)),
        'current': json['current'],
        'custom': json['custom'],
        'customPlanConfig': json['custom_plan_config'] == null ? undefined : CustomPlanConfigFromJSON(json['custom_plan_config']),
        'description': json['description'],
        'draftVersion': json['draft_version'] == null ? undefined : PlanVersionResponseDataFromJSON(json['draft_version']),
        'entitlements': json['entitlements'] == null ? undefined : ((json['entitlements'] as Array<any>).map(PlanEntitlementResponseDataFromJSON)),
        'features': ((json['features'] as Array<any>).map(FeatureInPlanResponseDataFromJSON)),
        'icon': PlanIconFromJSON(json['icon']),
        'id': json['id'],
        'includedCreditGrants': ((json['included_credit_grants'] as Array<any>).map(PlanCreditGrantViewFromJSON)),
        'invalidReason': json['invalid_reason'] == null ? undefined : CompanyPlanInvalidReasonFromJSON(json['invalid_reason']),
        'isCustom': json['is_custom'],
        'isDefault': json['is_default'],
        'isFree': json['is_free'] == null ? undefined : json['is_free'],
        'isTrialable': json['is_trialable'],
        'monthlyPrice': json['monthly_price'] == null ? undefined : BillingPriceResponseDataFromJSON(json['monthly_price']),
        'name': json['name'],
        'oneTimePrice': json['one_time_price'] == null ? undefined : BillingPriceResponseDataFromJSON(json['one_time_price']),
        'planType': PlanTypeFromJSON(json['plan_type']),
        'quarterlyPrice': json['quarterly_price'] == null ? undefined : BillingPriceResponseDataFromJSON(json['quarterly_price']),
        'trialDays': json['trial_days'] == null ? undefined : json['trial_days'],
        'updatedAt': (new Date(json['updated_at'])),
        'usageViolations': ((json['usage_violations'] as Array<any>).map(FeatureUsageResponseDataFromJSON)),
        'valid': json['valid'],
        'versions': ((json['versions'] as Array<any>).map(PlanVersionResponseDataFromJSON)),
        'yearlyPrice': json['yearly_price'] == null ? undefined : BillingPriceResponseDataFromJSON(json['yearly_price']),
    };
}

export function CompanyPlanDetailResponseDataToJSON(json: any): CompanyPlanDetailResponseData {
    return CompanyPlanDetailResponseDataToJSONTyped(json, false);
}

export function CompanyPlanDetailResponseDataToJSONTyped(value?: CompanyPlanDetailResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'available_periods': ((value['availablePeriods'] as Array<any>).map(PlanPriceCadenceToJSON)),
        'billing_linked_resource': BillingLinkedResourceResponseDataToJSON(value['billingLinkedResource']),
        ...
        'catalogs': value['catalogs'] == null ? undefined : ((value['catalogs'] as Array<any>).map(PlanCatalogMembershipResponseDataToJSON)),
        ...
        'credits': ((value['credits'] as Array<any>).map(BillingCreditResponseDataToJSON)),
        'currency_prices': ((value['currencyPrices'] as Array<any>).map(PlanCurrencyPricesResponseDataToJSON)),
        ...
        'entitlements': value['entitlements'] == null ? undefined : ((value['entitlements'] as Array<any>).map(PlanEntitlementResponseDataToJSON)),
        'features': ((value['features'] as Array<any>).map(FeatureInPlanResponseDataToJSON)),
        'icon': PlanIconToJSON(value['icon']),
        'id': value['id'],
        'included_credit_grants': ((value['includedCreditGrants'] as Array<any>).map(PlanCreditGrantViewToJSON)),
        ...
        'usage_violations': ((value['usageViolations'] as Array<any>).map(FeatureUsageResponseDataToJSON)),
        'valid': value['valid'],
        'versions': ((value['versions'] as Array<any>).map(PlanVersionResponseDataToJSON)),
