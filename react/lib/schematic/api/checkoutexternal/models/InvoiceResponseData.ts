 ...
 */
export function instanceOfInvoiceResponseData(value: object): value is InvoiceResponseData {
...
export function InvoiceResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): InvoiceResponseData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'id': json['id'],
        'paymentMethodExternalId': json['payment_method_external_id'] == null ? undefined : json['payment_method_external_id'],
        'providerType': BillingProviderTypeFromJSON(json['provider_type']),
        'startingBalance': json['starting_balance'],
        'status': json['status'] == null ? undefined : InvoiceStatusFromJSON(json['status']),
        'subscriptionExternalId': json['subscription_external_id'] == null ? undefined : json['subscription_external_id'],
...
export function InvoiceResponseDataToJSONTyped(value?: InvoiceResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
