 ...
 */
export function instanceOfRuleConditionDetailResponseData(value: object): value is RuleConditionDetailResponseData {
    ...
    if (!('traitValue' in value) || value['traitValue'] === undefined) return false;
    if (!('updatedAt' in value) || value['updatedAt'] === undefined) return false;
    return true;
}

export function RuleConditionDetailResponseDataFromJSON(json: any): RuleConditionDetailResponseData {
    return RuleConditionDetailResponseDataFromJSONTyped(json, false);
}

export function RuleConditionDetailResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): RuleConditionDetailResponseData {
    if (json == null) {
        return json;
    }
    return {
        
        'comparisonTrait': json['comparison_trait'] == null ? undefined : EntityTraitDefinitionResponseDataFromJSON(json['comparison_trait']),
        ...
        'metricValue': json['metric_value'] == null ? undefined : json['metric_value'],
        'operator': ComparableOperatorFromJSON(json['operator']),
        'resourceIds': json['resource_ids'],
        'resources': ((json['resources'] as Array<any>).map(PreviewObjectResponseDataFromJSON)),
        'ruleId': json['rule_id'],
        'trait': json['trait'] == null ? undefined : EntityTraitDefinitionResponseDataFromJSON(json['trait']),
        'traitEntityType': json['trait_entity_type'] == null ? undefined : EntityTypeFromJSON(json['trait_entity_type']),
...
export function RuleConditionDetailResponseDataToJSON(json: any): RuleConditionDetailResponseData {
    return RuleConditionDetailResponseDataToJSONTyped(json, false);
}

export function RuleConditionDetailResponseDataToJSONTyped(value?: RuleConditionDetailResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'comparison_trait': EntityTraitDefinitionResponseDataToJSON(value['comparisonTrait']),
        ...
        'resources': ((value['resources'] as Array<any>).map(PreviewObjectResponseDataToJSON)),
