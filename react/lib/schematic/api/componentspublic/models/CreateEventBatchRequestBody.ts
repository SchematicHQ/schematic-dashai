 ...
 */
export function instanceOfCreateEventBatchRequestBody(value: object): value is CreateEventBatchRequestBody {
    if (!('events' in value) || value['events'] === undefined) return false;
    return true;
}

export function CreateEventBatchRequestBodyFromJSON(json: any): CreateEventBatchRequestBody {
    return CreateEventBatchRequestBodyFromJSONTyped(json, false);
}

export function CreateEventBatchRequestBodyFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateEventBatchRequestBody {
    if (json == null) {
        return json;
    }
    return {
...
export function CreateEventBatchRequestBodyToJSON(json: any): CreateEventBatchRequestBody {
    return CreateEventBatchRequestBodyToJSONTyped(json, false);
}

export function CreateEventBatchRequestBodyToJSONTyped(value?: CreateEventBatchRequestBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
