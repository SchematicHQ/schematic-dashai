...
export function PreviewObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): PreviewObject {
    if (json == null) {
        return json;
    }
    return {
...
export function PreviewObjectToJSONTyped(value?: PreviewObject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
