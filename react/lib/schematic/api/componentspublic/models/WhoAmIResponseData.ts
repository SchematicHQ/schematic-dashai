...
export function WhoAmIResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): WhoAmIResponseData {
    ...
    return {
        ...
        'environments': ((json['environments'] as Array<any>).map(EnvironmentResponseDataFromJSON)),
        'stripeUserId': json['stripe_user_id'] == null ? undefined : json['stripe_user_id'],
...
export function WhoAmIResponseDataToJSONTyped(value?: WhoAmIResponseData | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'environments': ((value['environments'] as Array<any>).map(EnvironmentResponseDataToJSON)),
