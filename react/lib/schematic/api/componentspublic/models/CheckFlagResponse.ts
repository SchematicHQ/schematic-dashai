 ...
 */
export function instanceOfCheckFlagResponse(value: object): value is CheckFlagResponse {
...
export function CheckFlagResponseToJSONTyped(value?: CheckFlagResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
