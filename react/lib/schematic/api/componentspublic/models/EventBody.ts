 ...
 * @export
 */
export type EventBody = EventBodyFlagCheck | EventBodyIdentify | EventBodyInference | EventBodyTrack;
...
export function EventBodyToJSONTyped(value?: EventBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
