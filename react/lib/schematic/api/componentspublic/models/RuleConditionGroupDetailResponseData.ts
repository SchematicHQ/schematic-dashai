 ...
 */
export function instanceOfRuleConditionGroupDetailResponseData(value: object): value is RuleConditionGroupDetailResponseData {
...
export function RuleConditionGroupDetailResponseDataToJSON(json: any): RuleConditionGroupDetailResponseData {
    return RuleConditionGroupDetailResponseDataToJSONTyped(json, false);
}

export function RuleConditionGroupDetailResponseDataToJSONTyped(value?: RuleConditionGroupDetailResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
