 ...
 */
export function instanceOfEventBodyInference(value: object): value is EventBodyInference {
    ...
    if (!('responseModel' in value) || value['responseModel'] === undefined) return false;
    return true;
}
...
export function EventBodyInferenceFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventBodyInference {
    if (json == null) {
        return json;
    }
    return {
...
export function EventBodyInferenceToJSONTyped(value?: EventBodyInference | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
