...
export function PlanVersionStatusFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanVersionStatus {
...
export function PlanVersionStatusToJSONTyped(value: any, ignoreDiscriminator: boolean): PlanVersionStatus {
