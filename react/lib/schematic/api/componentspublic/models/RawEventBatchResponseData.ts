 ...
 */
export function instanceOfRawEventBatchResponseData(value: object): value is RawEventBatchResponseData {
...
export function RawEventBatchResponseDataToJSON(json: any): RawEventBatchResponseData {
    return RawEventBatchResponseDataToJSONTyped(json, false);
}

export function RawEventBatchResponseDataToJSONTyped(value?: RawEventBatchResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
