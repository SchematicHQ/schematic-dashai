 ...
 */
export function instanceOfPlanCreditGrantView(value: object): value is PlanCreditGrantView {
...
export function PlanCreditGrantViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanCreditGrantView {
    if (json == null) {
        return json;
    }
    return {
...
export function PlanCreditGrantViewToJSONTyped(value?: PlanCreditGrantView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
