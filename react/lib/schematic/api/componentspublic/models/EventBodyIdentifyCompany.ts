 ...
 */
export function instanceOfEventBodyIdentifyCompany(value: object): value is EventBodyIdentifyCompany {
...
export function EventBodyIdentifyCompanyToJSON(json: any): EventBodyIdentifyCompany {
    return EventBodyIdentifyCompanyToJSONTyped(json, false);
}

export function EventBodyIdentifyCompanyToJSONTyped(value?: EventBodyIdentifyCompany | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
