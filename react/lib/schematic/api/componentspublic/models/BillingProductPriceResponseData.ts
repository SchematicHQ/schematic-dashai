 ...
 */
export function instanceOfBillingProductPriceResponseData(value: object): value is BillingProductPriceResponseData {
...
export function BillingProductPriceResponseDataFromJSON(json: any): BillingProductPriceResponseData {
    return BillingProductPriceResponseDataFromJSONTyped(json, false);
}

export function BillingProductPriceResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): BillingProductPriceResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function BillingProductPriceResponseDataToJSON(json: any): BillingProductPriceResponseData {
    return BillingProductPriceResponseDataToJSONTyped(json, false);
}

export function BillingProductPriceResponseDataToJSONTyped(value?: BillingProductPriceResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
