 ...
 */
export function instanceOfBillingProductDetailResponseData(value: object): value is BillingProductDetailResponseData {
...
export function BillingProductDetailResponseDataFromJSON(json: any): BillingProductDetailResponseData {
    return BillingProductDetailResponseDataFromJSONTyped(json, false);
}

export function BillingProductDetailResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): BillingProductDetailResponseData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'prices': ((json['prices'] as Array<any>).map(BillingPriceResponseDataFromJSON)),
...
export function BillingProductDetailResponseDataToJSON(json: any): BillingProductDetailResponseData {
    return BillingProductDetailResponseDataToJSONTyped(json, false);
}

export function BillingProductDetailResponseDataToJSONTyped(value?: BillingProductDetailResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
