 ...
 */
export function instanceOfCheckFlagsResponse(value: object): value is CheckFlagsResponse {
...
export function CheckFlagsResponseToJSONTyped(value?: CheckFlagsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
