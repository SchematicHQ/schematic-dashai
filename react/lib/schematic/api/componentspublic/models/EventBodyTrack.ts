 ...
 */
export function instanceOfEventBodyTrack(value: object): value is EventBodyTrack {
...
export function EventBodyTrackToJSONTyped(value?: EventBodyTrack | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
