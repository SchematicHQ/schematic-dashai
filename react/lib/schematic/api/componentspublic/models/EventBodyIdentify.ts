 ...
 */
export function instanceOfEventBodyIdentify(value: object): value is EventBodyIdentify {
...
export function EventBodyIdentifyToJSONTyped(value?: EventBodyIdentify | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
