 ...
 */
export function instanceOfEntityTraitDefinitionResponseData(value: object): value is EntityTraitDefinitionResponseData {
...
export function EntityTraitDefinitionResponseDataToJSON(json: any): EntityTraitDefinitionResponseData {
    return EntityTraitDefinitionResponseDataToJSONTyped(json, false);
}

export function EntityTraitDefinitionResponseDataToJSONTyped(value?: EntityTraitDefinitionResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
