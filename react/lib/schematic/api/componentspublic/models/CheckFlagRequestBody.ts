 ...
 */
export function instanceOfCheckFlagRequestBody(value: object): value is CheckFlagRequestBody {
    return true;
}
...
export function CheckFlagRequestBodyToJSONTyped(value?: CheckFlagRequestBody | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
