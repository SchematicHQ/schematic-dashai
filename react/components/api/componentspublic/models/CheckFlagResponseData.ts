 ...
 */
export function instanceOfCheckFlagResponseData(value: object): value is CheckFlagResponseData {
...
export function CheckFlagResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CheckFlagResponseData {
    ...
    return {
        ...
        'entitlement': json['entitlement'] == null ? undefined : FeatureEntitlementFromJSON(json['entitlement']),
        'error': json['error'] == null ? undefined : json['error'],
        'featureAllocation': json['feature_allocation'] == null ? undefined : json['feature_allocation'],
        'featureUsage': json['feature_usage'] == null ? undefined : json['feature_usage'],
        'featureUsageEvent': json['feature_usage_event'] == null ? undefined : json['feature_usage_event'],
        'featureUsagePeriod': json['feature_usage_period'] == null ? undefined : MetricPeriodFromJSON(json['feature_usage_period']),
        'featureUsageResetAt': json['feature_usage_reset_at'] == null ? undefined : (new Date(json['feature_usage_reset_at'])),
        'flag': json['flag'],
        'flagId': json['flag_id'] == null ? undefined : json['flag_id'],
        'reason': json['reason'],
        'ruleId': json['rule_id'] == null ? undefined : json['rule_id'],
        'ruleType': json['rule_type'] == null ? undefined : RuleTypeFromJSON(json['rule_type']),
...
export function CheckFlagResponseDataToJSONTyped(value?: CheckFlagResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'feature_usage_reset_at': value['featureUsageResetAt'] == null ? undefined : ((value['featureUsageResetAt'] as any).toISOString()),
        'flag': value['flag'],
