 ...
 */
export function instanceOfFlagResponseData(value: object): value is FlagResponseData {
...
export function FlagResponseDataToJSONTyped(value?: FlagResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
