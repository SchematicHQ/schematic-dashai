 ...
 */
export function instanceOfPlanResponseData(value: object): value is PlanResponseData {
...
export function PlanResponseDataToJSONTyped(value?: PlanResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
