...
export function TraitTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): TraitType {
...
export function TraitTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): TraitType {
