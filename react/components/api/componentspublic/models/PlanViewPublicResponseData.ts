 ...
 */
export function instanceOfPlanViewPublicResponseData(value: object): value is PlanViewPublicResponseData {
...
export function PlanViewPublicResponseDataFromJSON(json: any): PlanViewPublicResponseData {
    return PlanViewPublicResponseDataFromJSONTyped(json, false);
}

export function PlanViewPublicResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanViewPublicResponseData {
    if (json == null) {
        return json;
    }
    return {
...
export function PlanViewPublicResponseDataToJSON(json: any): PlanViewPublicResponseData {
    return PlanViewPublicResponseDataToJSONTyped(json, false);
}

export function PlanViewPublicResponseDataToJSONTyped(value?: PlanViewPublicResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
