 ...
 */
export function instanceOfRuleDetailResponseData(value: object): value is RuleDetailResponseData {
...
export function RuleDetailResponseDataToJSON(json: any): RuleDetailResponseData {
    return RuleDetailResponseDataToJSONTyped(json, false);
}

export function RuleDetailResponseDataToJSONTyped(value?: RuleDetailResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
