 ...
 */
export function instanceOfRawEventResponseData(value: object): value is RawEventResponseData {
...
export function RawEventResponseDataToJSONTyped(value?: RawEventResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
