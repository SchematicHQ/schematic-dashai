 ...
 */
export function instanceOfEventBodyFlagCheck(value: object): value is EventBodyFlagCheck {
...
export function EventBodyFlagCheckFromJSONTyped(json: any, ignoreDiscriminator: boolean): EventBodyFlagCheck {
    if (json == null) {
        return json;
    }
    return {
...
export function EventBodyFlagCheckToJSONTyped(value?: EventBodyFlagCheck | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
