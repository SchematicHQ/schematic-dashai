 ...
 */
export function instanceOfGenericPreviewObject(value: object): value is GenericPreviewObject {
...
export function GenericPreviewObjectFromJSONTyped(json: any, ignoreDiscriminator: boolean): GenericPreviewObject {
    if (json == null) {
        return json;
    }
    return {
...
export function GenericPreviewObjectToJSONTyped(value?: GenericPreviewObject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
