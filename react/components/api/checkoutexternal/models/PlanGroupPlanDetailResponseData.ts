 ...
 */
export function instanceOfPlanGroupPlanDetailResponseData(value: object): value is PlanGroupPlanDetailResponseData {
...
export function PlanGroupPlanDetailResponseDataFromJSON(json: any): PlanGroupPlanDetailResponseData {
    return PlanGroupPlanDetailResponseDataFromJSONTyped(json, false);
}

export function PlanGroupPlanDetailResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlanGroupPlanDetailResponseData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'customPlanConfig': json['custom_plan_config'] == null ? undefined : CustomPlanViewConfigResponseDataFromJSON(json['custom_plan_config']),
        ...
        'id': json['id'],
        'includedCreditGrants': json['included_credit_grants'] == null ? undefined : ((json['included_credit_grants'] as Array<any>).map(BillingPlanCreditGrantResponseDataFromJSON)),
...
export function PlanGroupPlanDetailResponseDataToJSON(json: any): PlanGroupPlanDetailResponseData {
    return PlanGroupPlanDetailResponseDataToJSONTyped(json, false);
}

export function PlanGroupPlanDetailResponseDataToJSONTyped(value?: PlanGroupPlanDetailResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'custom_plan_config': CustomPlanViewConfigResponseDataToJSON(value['customPlanConfig']),
        ...
        'id': value['id'],
        'included_credit_grants': value['includedCreditGrants'] == null ? undefined : ((value['includedCreditGrants'] as Array<any>).map(BillingPlanCreditGrantResponseDataToJSON)),
