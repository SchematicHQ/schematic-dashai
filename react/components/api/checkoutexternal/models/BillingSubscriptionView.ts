 ...
 */
export function instanceOfBillingSubscriptionView(value: object): value is BillingSubscriptionView {
...
export function BillingSubscriptionViewFromJSON(json: any): BillingSubscriptionView {
    return BillingSubscriptionViewFromJSONTyped(json, false);
}

export function BillingSubscriptionViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): BillingSubscriptionView {
    if (json == null) {
        return json;
    }
    return {
        ...
        'discounts': ((json['discounts'] as Array<any>).map(BillingSubscriptionDiscountViewFromJSON)),
        'expiredAt': json['expired_at'] == null ? undefined : (new Date(json['expired_at'])),
        'id': json['id'],
        'interval': json['interval'],
        'latestInvoice': json['latest_invoice'] == null ? undefined : InvoiceResponseDataFromJSON(json['latest_invoice']),
        'metadata': json['metadata'] == null ? undefined : json['metadata'],
        'paymentMethod': json['payment_method'] == null ? undefined : PaymentMethodResponseDataFromJSON(json['payment_method']),
        'periodEnd': json['period_end'],
        'periodStart': json['period_start'],
        'products': ((json['products'] as Array<any>).map(BillingProductForSubscriptionResponseDataFromJSON)),
...
export function BillingSubscriptionViewToJSON(json: any): BillingSubscriptionView {
    return BillingSubscriptionViewToJSONTyped(json, false);
}

export function BillingSubscriptionViewToJSONTyped(value?: BillingSubscriptionView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'discounts': ((value['discounts'] as Array<any>).map(BillingSubscriptionDiscountViewToJSON)),
        ...
        'products': ((value['products'] as Array<any>).map(BillingProductForSubscriptionResponseDataToJSON)),
