 ...
 */
export function instanceOfEntityKeyDetailResponseData(value: object): value is EntityKeyDetailResponseData {
...
export function EntityKeyDetailResponseDataFromJSON(json: any): EntityKeyDetailResponseData {
    return EntityKeyDetailResponseDataFromJSONTyped(json, false);
}

export function EntityKeyDetailResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntityKeyDetailResponseData {
    if (json == null) {
        return json;
    }
    return {
        ...
        'definition': json['definition'] == null ? undefined : EntityKeyDefinitionResponseDataFromJSON(json['definition']),
...
export function EntityKeyDetailResponseDataToJSON(json: any): EntityKeyDetailResponseData {
    return EntityKeyDetailResponseDataToJSONTyped(json, false);
}

export function EntityKeyDetailResponseDataToJSONTyped(value?: EntityKeyDetailResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
