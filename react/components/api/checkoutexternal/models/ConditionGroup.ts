 ...
 */
export function instanceOfConditionGroup(value: object): value is ConditionGroup {
...
export function ConditionGroupToJSONTyped(value?: ConditionGroup | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
