...
export function FlagTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FlagType {
...
export function FlagTypeToJSONTyped(value: any, ignoreDiscriminator: boolean): FlagType {
