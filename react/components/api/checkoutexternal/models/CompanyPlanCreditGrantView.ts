 ...
 */
export function instanceOfCompanyPlanCreditGrantView(value: object): value is CompanyPlanCreditGrantView {
    if (!('billingCreditAutoTopupEnabled' in value) || value['billingCreditAutoTopupEnabled'] === undefined) return false;
    if (!('billingCreditAutoTopupSelfService' in value) || value['billingCreditAutoTopupSelfService'] === undefined) return false;
    if (!('billingCreditCanBuyBundles' in value) || value['billingCreditCanBuyBundles'] === undefined) return false;
    if (!('createdAt' in value) || value['createdAt'] === undefined) return false;
    if (!('creditAmount' in value) || value['creditAmount'] === undefined) return false;
    if (!('creditDescription' in value) || value['creditDescription'] === undefined) return false;
    if (!('creditId' in value) || value['creditId'] === undefined) return false;
    if (!('creditName' in value) || value['creditName'] === undefined) return false;
    ...
    if (!('rolloverPercentage' in value) || value['rolloverPercentage'] === undefined) return false;
    if (!('updatedAt' in value) || value['updatedAt'] === undefined) return false;
    return true;
}

export function CompanyPlanCreditGrantViewFromJSON(json: any): CompanyPlanCreditGrantView {
    return CompanyPlanCreditGrantViewFromJSONTyped(json, false);
}

export function CompanyPlanCreditGrantViewFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompanyPlanCreditGrantView {
    if (json == null) {
        return json;
    }
    return {
        
        'billingCreditAutoTopupAmount': json['billing_credit_auto_topup_amount'] == null ? undefined : json['billing_credit_auto_topup_amount'],
        'billingCreditAutoTopupAmountType': json['billing_credit_auto_topup_amount_type'] == null ? undefined : json['billing_credit_auto_topup_amount_type'],
        'billingCreditAutoTopupAvailability': json['billing_credit_auto_topup_availability'] == null ? undefined : BillingCreditAutoTopupAvailabilityFromJSON(json['billing_credit_auto_topup_availability']),
        'billingCreditAutoTopupEnabled': json['billing_credit_auto_topup_enabled'],
        'billingCreditAutoTopupExpiryType': json['billing_credit_auto_topup_expiry_type'] == null ? undefined : BillingCreditExpiryTypeFromJSON(json['billing_credit_auto_topup_expiry_type']),
        'billingCreditAutoTopupExpiryUnit': json['billing_credit_auto_topup_expiry_unit'] == null ? undefined : BillingCreditExpiryUnitFromJSON(json['billing_credit_auto_topup_expiry_unit']),
        'billingCreditAutoTopupExpiryUnitCount': json['billing_credit_auto_topup_expiry_unit_count'] == null ? undefined : json['billing_credit_auto_topup_expiry_unit_count'],
        'billingCreditAutoTopupSelfService': json['billing_credit_auto_topup_self_service'],
        'billingCreditAutoTopupThresholdCredits': json['billing_credit_auto_topup_threshold_credits'] == null ? undefined : json['billing_credit_auto_topup_threshold_credits'],
        'billingCreditAutoTopupThresholdPercent': json['billing_credit_auto_topup_threshold_percent'] == null ? undefined : json['billing_credit_auto_topup_threshold_percent'],
        'billingCreditCanBuyBundles': json['billing_credit_can_buy_bundles'],
        'companyAutoTopupAmount': json['company_auto_topup_amount'] == null ? undefined : json['company_auto_topup_amount'],
        'companyAutoTopupEnabled': json['company_auto_topup_enabled'] == null ? undefined : json['company_auto_topup_enabled'],
        'companyAutoTopupThresholdCredits': json['company_auto_topup_threshold_credits'] == null ? undefined : json['company_auto_topup_threshold_credits'],
        'createdAt': (new Date(json['created_at'])),
        'credit': json['credit'] == null ? undefined : BillingCreditViewFromJSON(json['credit']),
        ...
        'expiryType': json['expiry_type'] == null ? undefined : BillingCreditExpiryTypeFromJSON(json['expiry_type']),
        'expiryUnit': json['expiry_unit'] == null ? undefined : BillingCreditExpiryUnitFromJSON(json['expiry_unit']),
        'expiryUnitCount': json['expiry_unit_count'] == null ? undefined : json['expiry_unit_count'],
        'id': json['id'],
        'plan': json['plan'] == null ? undefined : GenericPreviewObjectFromJSON(json['plan']),
        'planId': json['plan_id'],
        'planVersionId': json['plan_version_id'] == null ? undefined : json['plan_version_id'],
        'pluralName': json['plural_name'] == null ? undefined : json['plural_name'],
        'resetCadence': json['reset_cadence'] == null ? undefined : BillingPlanCreditGrantResetCadenceFromJSON(json['reset_cadence']),
        'resetStart': json['reset_start'] == null ? undefined : BillingPlanCreditGrantResetStartFromJSON(json['reset_start']),
        'resetType': BillingPlanCreditGrantResetTypeFromJSON(json['reset_type']),
        'rolloverPercentage': json['rollover_percentage'],
        'singularName': json['singular_name'] == null ? undefined : json['singular_name'],
        'updatedAt': (new Date(json['updated_at'])),
    };
}

export function CompanyPlanCreditGrantViewToJSON(json: any): CompanyPlanCreditGrantView {
    return CompanyPlanCreditGrantViewToJSONTyped(json, false);
}

export function CompanyPlanCreditGrantViewToJSONTyped(value?: CompanyPlanCreditGrantView | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'billing_credit_auto_topup_amount_type': value['billingCreditAutoTopupAmountType'],
        'billing_credit_auto_topup_availability': BillingCreditAutoTopupAvailabilityToJSON(value['billingCreditAutoTopupAvailability']),
        'billing_credit_auto_topup_enabled': value['billingCreditAutoTopupEnabled'],
        'billing_credit_auto_topup_expiry_type': BillingCreditExpiryTypeToJSON(value['billingCreditAutoTopupExpiryType']),
        'billing_credit_auto_topup_expiry_unit': BillingCreditExpiryUnitToJSON(value['billingCreditAutoTopupExpiryUnit']),
        'billing_credit_auto_topup_expiry_unit_count': value['billingCreditAutoTopupExpiryUnitCount'],
        'billing_credit_auto_topup_self_service': value['billingCreditAutoTopupSelfService'],
        'billing_credit_auto_topup_threshold_credits': value['billingCreditAutoTopupThresholdCredits'],
        'billing_credit_auto_topup_threshold_percent': value['billingCreditAutoTopupThresholdPercent'],
        ...
        'company_auto_topup_threshold_credits': value['companyAutoTopupThresholdCredits'],
        ...
        'reset_cadence': BillingPlanCreditGrantResetCadenceToJSON(value['resetCadence']),
