 ...
 */
export function instanceOfBillingSubscriptionResponseData(value: object): value is BillingSubscriptionResponseData {
...
export function BillingSubscriptionResponseDataToJSON(json: any): BillingSubscriptionResponseData {
    return BillingSubscriptionResponseDataToJSONTyped(json, false);
}

export function BillingSubscriptionResponseDataToJSONTyped(value?: BillingSubscriptionResponseData | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
